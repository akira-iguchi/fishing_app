...
<h4>2，釣りの予定、記録を管理できるように</h4>
さらに、釣りスポットや釣り方だけでなく、釣りは天気、道具などのチェックや、今後のために釣りを記録することも多いです。そのため、カレンダーに釣りの予定や記録を入れて忘れないで欲しいためにも、このサービスを開発しようと思いました。
