...
class EventControllerTest extends TestCase
{
    ...
    // function testEditEventDate($params)
    // {
    //     $user = User::factory()->create();
    //     $this->actingAs($user);
    ...
    //     $response = $this->get(route('editEvent', [$event, $user]));
    ...
    //     $response = $this->from(route('editEvent', [$event, $user]))->put(route('events.update', [$event, $user]), $params['requestData']);
    ...
    //     $response = $this->delete(route('deleteEvent', [$event, $user]));
